<template>
	<div class="mode">
		<div class='mode-wrapper'>
			<div class='mode-text'>外链模式：如果你已经有了一个链接且用户需通过此链接线上申请相应产品，比如一个信贷产品链接、京东或者拼多多产品链接，将一个链接嵌入到统客来分销的方式，我们称之为外链模式。
			</div>
			<div class='mode-text'>
				如果您恰好是以上的方式，我们建议您选择【统客外链模式】来分销您的产品。
			</div>
			<div class='mode-text'>
...
export default {
	...
	methods:{
		...
		isConfirm(){
			...
			this.axios.post('/api/buildproductsmode',{openID:openID,mode:'link'})
			.then(function(res){
